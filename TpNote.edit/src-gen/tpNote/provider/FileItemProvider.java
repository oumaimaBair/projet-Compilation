...
/**
 * This is the item provider adapter for a {@link tpNote.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_File_path_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_File_path_feature", "_UI_File_type"),
						TpNotePackage.Literals.FILE__PATH, true, false, false,
	...
	protected void addDelimiterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_File_delimiter_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_File_delimiter_feature", "_UI_File_type"),
						TpNotePackage.Literals.FILE__DELIMITER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TpNotePackage.Literals.FILE__KEEP);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case TpNotePackage.FILE__PATH:
		case TpNotePackage.FILE__DELIMITER:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case TpNotePackage.FILE__KEEP:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(TpNotePackage.Literals.FILE__KEEP, TpNoteFactory.eINSTANCE.createextractedData()));
	}
